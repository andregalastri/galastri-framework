...
/**
 * This file configures the debug status of the framework. Useful while developing, but turn all
 * them to false when in production because any error can show sensitive data do public users.
 */

return [
    /**
     * Enables the debug tool that will show detailed errors in configuration files, or mistakes
     * with the framework tools. Also enables the PHP display_errors status, which means that
     * internal PHP errors will be shown.
     *
     ...
     *
     * This is executed to EVERY request made, so, be careful to enable this because this could
     * create a large log file or, if the execution is too big, it can crash the execution.
     *
